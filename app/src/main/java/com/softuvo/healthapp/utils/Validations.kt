...
//                imm.showSoftInput(view, InputMethodManager.SHOW_IMPLICIT)
        ...
        fun isValidateLogin(applicationContext: Context, mEtEmail: EditText, mEtPassword: EditText): Boolean {
            if (!validateEmailAddress(applicationContext, mEtEmail, applicationContext.resources.getString(R.string.err_msg_email_address))) {
                return false
            }
            if (!validateFullname(applicationContext, mEtPassword, applicationContext.resources.getString(R.string.err_msg_password))) {
                return false
            }
            if (!CommonUtils.isInternetConnection(applicationContext)) {
                CommonUtils.showSnackbarMessage(applicationContext, applicationContext.resources.getString(R.string.err_msg_internet), R.color.colorAccent)
                return false
            }
            return true
        }
        ...
        fun isValidateSignUp(applicationContext: Context, mEtFullName: EditText, mEtEmail: EditText, mEtPassword: EditText, mEtCnfPassword: EditText): Boolean {
            if (!validateFullname(applicationContext, mEtFullName, applicationContext.resources.getString(R.string.err_msg_full_name))) {
                return false
            }
            if (!validateFullnameLength(applicationContext, mEtFullName, applicationContext.resources.getString(R.string.err_msg_full_name))) {
                return false
            }
            if (!validateEmailAddress(applicationContext, mEtEmail, applicationContext.resources.getString(R.string.err_msg_email_address))) {
                return false
            ...
            if (!validatePasswordLength(applicationContext, mEtPassword, applicationContext.resources.getString(R.string.err_msg_password_length))) {
                return false
            }
            if (!validatePasswordContainSpecialCharacter(applicationContext, mEtPassword, applicationContext.resources.getString(R.string.err_msg_password_length))) {
                return false
            }
            if (!validateFullname(applicationContext, mEtCnfPassword, applicationContext.resources.getString(R.string.err_msg_confirm_password))) {
                return false
            }
            if (!validateConfirmPassword(applicationContext, mEtPassword, mEtCnfPassword, applicationContext.resources.getString(R.string.err_msg_same_confirm_password))) {
                return false
            }
            if (!CommonUtils.isInternetConnection(applicationContext)) {
                CommonUtils.showSnackbarMessage(applicationContext, applicationContext.resources.getString(R.string.err_msg_internet), R.color.colorAccent)
        ...
        fun isValidateJoinAsMerchant(applicationContext: Context, mEtBusinessName: EditText, mEtRegNo: EditText, mEtnature: EditText,mEtEmail: EditText, mEtContactNo: EditText,mEtPostalCode: EditText): Boolean {
            ...
            if (!validateLocation(applicationContext, mEtBusinessName, applicationContext.resources.getString(R.string.err_msg_buisness_name))) {
                return false
            }
            if (!validateLocation(applicationContext, mEtRegNo, applicationContext.resources.getString(R.string.err_msg_buisness_reg_no))) {
                return false
            }
            if (!validateLocation(applicationContext, mEtnature, applicationContext.resources.getString(R.string.err_msg_buisness_nature))) {
                return false
            }
            if (!validateLocation(applicationContext, mEtContactNo, applicationContext.resources.getString(R.string.err_msg_contact_no))) {
                return false
            }
            if (!validateLocation(applicationContext, mEtPostalCode, applicationContext.resources.getString(R.string.err_msg_postal_code))) {
                return false
            }
        ...
        fun isValidateChangePassword(applicationContext: Context, mEtCurrentPassword: EditText, mEtNewPassword: EditText, mEtVerifyPassword: EditText): Boolean {
            if (!validateCurrentPassword(applicationContext, mEtCurrentPassword, applicationContext.resources.getString(R.string.err_msg_current_password))) {
                return false
            }
            ...
            if (!validatePasswordContainSpecialCharacter(applicationContext, mEtNewPassword, applicationContext.resources.getString(R.string.err_msg_password_length))) {
                return false
            }
            if (!validateConfirmPassword(applicationContext, mEtNewPassword, mEtVerifyPassword, applicationContext.resources.getString(R.string.err_msg_same_confirm_password))) {
                return false
            }
            if (!CommonUtils.isInternetConnection(applicationContext)) {
                CommonUtils.showSnackbarMessage(applicationContext, applicationContext.resources.getString(R.string.err_msg_internet), R.color.colorAccent)
